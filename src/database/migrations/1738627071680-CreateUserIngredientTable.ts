...
export class CreateUserIngredientTable1738627071680 implements MigrationInterface {
    name = 'CreateUserIngredientTable1738627071680'

    public async up(queryRunner: QueryRunner): Promise<void> {
        await queryRunner.query(`CREATE TABLE "tbl_UserIngredients" ("id" uuid NOT NULL DEFAULT uuid_generate_v4(), "unitQuantity" integer NOT NULL DEFAULT '1', "totalAmount" numeric(10,2), "unitType" character varying(50), "expiry_date" TIMESTAMP, "added_at" TIMESTAMP NOT NULL DEFAULT now(), "user_id" uuid, "ingredient_id" integer, CONSTRAINT "UQ_e90aeaceb1cc1da7a0272518563" UNIQUE ("user_id", "ingredient_id"), CONSTRAINT "CHK_1ef44a66f44b5da9be3ea4f1f5" CHECK ("totalAmount" >= 0), CONSTRAINT "CHK_90181a01be4fc97d6cff89afbe" CHECK ("unitQuantity" >= 0), CONSTRAINT "PK_8f14ecc19afa39d131111d42623" PRIMARY KEY ("id"))`);
